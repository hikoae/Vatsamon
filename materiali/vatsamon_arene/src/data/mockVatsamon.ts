import { Vatsamon, Hotspot } from '../types';

export const INITIAL_VATSADEX: Vatsamon[] = [
  {
    id: "vatsa-init-1",
...
export const DEMO_PREMIUM_COWS: Vatsamon[] = [
  {
    id: "demo-gold-reina",
    breed: "Regina d'Oro",
...
export const HP_LOCATIONS: Hotspot[] = [
  ...
  },
  {
    ...
    description: "Cieli tra i più limpidi d'Europa e una vallata baciata dal sole. Adatta per incontrare i misteriosi Vatsamon celestiali e notturni."
  },
  {
    id: "hp-fenis",
  ...
  },
  {
    ...
    lng: 7.744,
    difficulty: "Difficile",
    description: "Forte storico che controlla i transiti di vetta. Spesso vi si radunano i guerrieri Vatsamon leggendari per sfidarsi all'ombra delle mura."
  }
];
