...
- **Dati:** `data/vatsadex.json` statico, caricato all'avvio. Nessun backend.
...
3. **Cattura:** carica/scatta foto → Gemini classifica la razza (3 razze + "non è una mucca").
   - Razza riconosciuta e mucca nel DB → si apre la **scheda** (card Pokédex) e va in Vatsadex.
...
4. **Vatsadex:** griglia delle bovine catturate, con stelle di rarità e stat.
