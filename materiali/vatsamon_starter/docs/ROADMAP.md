...
- [ ] Carica `data/vatsadex.json`.
- [ ] Verifica che l'app generata mostri Vatsadex + mappa anche senza IA.
- [ ] Ottieni/incolla la **API key Gemini** (AI Studio la gestisce in Build).

## ⏱ Blocco 1 — Mappa + incontri (0:20 – 1:20)  ← PRIORITÀ
- [ ] Leaflet con i 6 pascoli (coordinate già in `vatsadex.json` → `pascoli`).
