...
const DICT = {
  it: {
    ...
    adm_tappa: "Tappa",
    adm_nomePh: "Nome della vincitrice",
    adm_notePh: "Nota (opzionale)",
    ...
    fol_bannerOggi: "🚨 {nome} gareggia OGGI a {comune}!",
    fol_bannerDomenica: "{nome} gareggia domenica a {comune}.",
    fol_storico: "Storico stagione",
    fol_storicoVuoto: "Nessuna apparizione ancora registrata in questa stagione per questa Reina.",
    fol_storicoVittoria: "Vittoria ufficiale",
    fol_storicoGareggia: "Gareggia",
    fol_storicoGareggiata: "Ha gareggiato",
    fol_storicoSeed: "Testa di serie per la finale",
    fol_storicoReine: "Reine des Reines 2026!",
    // scopri
  ...
  fr: {
    ...
    adm_tappa: "Étape",
    adm_nomePh: "Nom de la gagnante",
    adm_notePh: "Note (facultatif)",
    ...
    fol_bannerOggi: "🚨 {nome} combat AUJOURD'HUI à {comune} !",
    fol_bannerDomenica: "{nome} combat dimanche à {comune}.",
    fol_storico: "Historique de la saison",
    fol_storicoVuoto: "Aucune apparition encore enregistrée cette saison pour cette Reine.",
    fol_storicoVittoria: "Victoire officielle",
    fol_storicoGareggia: "En lice",
    fol_storicoGareggiata: "A participé",
    fol_storicoSeed: "Tête de série pour la finale",
    fol_storicoReine: "Reine des Reines 2026 !",
