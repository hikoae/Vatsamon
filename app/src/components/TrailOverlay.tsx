    ...
    trail.landmarks.forEach((lm) => {
      const icon = L.divIcon({
        ...
        html: `<div class="flex flex-col items-center">
                 ...
                 <div class="px-1.5 py-0.5 rounded bg-[#211b3a]/95 border border-amber-700 text-[10px] text-amber-100 font-mono font-bold whitespace-nowrap" style="transform: translateY(-8px);">${lm.name}</div>
               </div>`,
        iconSize: [40, 46],
        iconAnchor: [20, 23],
      });
